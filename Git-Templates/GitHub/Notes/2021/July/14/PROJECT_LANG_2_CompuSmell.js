// Start of script
// I chose JavaScript as the second project language for this project (CompuSmell) as Python is one of the 2 common languages that inspired the design of the VSmell language invented through this project.
