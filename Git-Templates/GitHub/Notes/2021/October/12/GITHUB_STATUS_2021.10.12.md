...
### Status update: 2021 October 12th
...
🎂 **Days until 2 year GitHub :octocat: anniversary:** `234` _(as of 2021 October 12th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #1 !-->

:octocat: **GitHub consecutive day count:** `495/540` _Count revised and updated on July 16th 2021 via_ [DuckDuckGo](https://duckduckgo.com/?t=ffab&q=Days+since+May+25th+2020&ia=answer) _(As of 2021 October 12th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #2 !-->

🐧 **Linux desktop consecutive day count:** `454/495` _(as of 2021 October 12th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #3 !-->

🪟 **Windows 10 with GitHub consecutive day count:** `45` <!-- (Yes I am aware that the count messed up in the past 2 weeks. I haven't gotten to fixing it yet) !--> _(as of 2021 October 12th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #4 !-->

🐧 **Ubuntu 20.04 with GitHub consecutive day count:** `454/495`  _(as of 2021 October 12th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #5 !-->

:atom: **Total amount of original GitHub repositories:** `1,256+o` _(as of 2021 October 12th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #6 !-->

:atom: o=organizations, total number of non-fork organization repositories: `107` _as of 2021 October 12th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #7 !-->
...
:electron: **Repositories created so far this month:** `126+o` _(as of 2021 October 12th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #8 !-->

:shipit: **Organization count:** `667` _(as of 2021 October 12th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #9 !-->

:electron: **Organizations created so far this month:** `6` _(as of 2021 October 12th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #10 !-->
...
I had a good day with development today. I continued to work on the GitHub Organization Info project, working on catching up on it still. I still have 2 days left on the todo list subproject. I completed my journaling work early today, along with my marine biology notes/fishtank activity log. I dealt with focus issues throughout the day. I also stumbled upon the GNU website again, and have also been doing extensive research on writing articles. My possible syntax problems in what I am currently writing is not what is being researched unfortunately. I am researching critical writing, and GNU has really good documentation on this. I would recommend it as a source of information. I am researching terms to replace, and am still undergoing a transformation that started in 2018. The more I research this, the more I realize we are living in a dystopia. It is quite depressing, honestly.

For transparency today, I released info on a pact with Microsoft, but the information is being updated. This pact is from internal documents, and is not sensitive, so it can be released before 2040. I don't have a complete definition yet, this is still subject to being updated.

I am starting to become extremely critical of G%%gles Fuchsia operating system and its Zircon kernel. I am seeing the [Tanenbaum-Torvalds](https://en.wikipedia.org/wiki/Tanenbaum-Torvalds_debate) argument being mentioned. Supporters of G%%gle Fuchsia are saying that Tanenbaum was right and Torvalds was wrong, which is untrue. Still, it is a threat to Linux adoption, as it will cut out over 80% of Linuxs mobile marketshare (Android) and 2% of Linux's desktop marketshare (Chromium OS and ChromeOS) if G%%gle switches entirely to fuchsia. It might not seem like much of a loss, but it would hurt Linux adoption greatly. (The o in G%%gle is being censored here, as G%%gles mass-surveillance [eyeholes](https://rickandmorty.fandom.com/wiki/Eyehole_Man) should not peak out here, and also because I see the company name as a pejorative)

I have had plans to update my server documentation recently, but I haven't had the time. Same with my status post that you are currently reading. Some of it was written today (2021 Tuesday October 12th) while some of it was written today (2021 Thursday October 14th)
...
_-_ Your page deployments are going to expire. Figure out how to automatically bump them up. ~~like they are humanoids~~ (why is this string here?) _-_
...
I succeeded in catching up tonight, and I stayed caught up today. - 2021 October 9th to October 12th
...
**Line count (including blank lines and compiler line):** `3,386`
