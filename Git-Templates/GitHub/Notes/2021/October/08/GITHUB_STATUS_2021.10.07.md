...
### Status update: 2021 October 7th
...
🎂 **Days until 2 year GitHub :octocat: anniversary:** `237` _(as of 2021 October 7th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #1 !-->

:octocat: **GitHub consecutive day count:** `492/537` _Count revised and updated on July 16th 2021 via_ [DuckDuckGo](https://duckduckgo.com/?t=ffab&q=Days+since+May+25th+2020&ia=answer) _(As of 2021 October 7th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #2 !-->

🐧 **Linux desktop consecutive day count:** `451/492` _(as of 2021 October 7th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #3 !-->
...
🐧 **Ubuntu 20.04 with GitHub consecutive day count:** `451/492`  _(as of 2021 October 6th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #5 !-->

:atom: **Total amount of original GitHub repositories:** `1,146+o` _(as of 2021 October 6th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #6 !-->
...
I had an OK day with development. I was a bit distracted, and I didn't get that much done.

Today, I realized that I go through a 4 stage disaster every morning with the laptop, which is:

1. Pre-boot system scan (failing component)

2. Mouse problems at the pre-boot system scan (really finicky and difficult)

3. Boot flicker

4. Tracker reset --hard

```shell 
Tracker reset --hard
```

I should only have to go through 1 step, which is the tracker reset --hard, but in an ideal workspace, I shouldn’t have to go through any of this. It is still far better than Windows, but I should not have stuck with Ubuntu. I really feel like I should have switched to a different distribution. Since day 1 of using Linux, my opinion on Fedora Linux has changed, the one thing that makes me not like it as much now is the fact that the system has to be upgraded so often. I can’t even handle application updates on Ubuntu due to fears of bricking my system, how am I supposed to do a full system upgrade every few months? I may go with pure Debian or Arch Linux next (not because of the Arch Linux elitist phrase “I use arch btw” but because I have gotten lots of reports from many people and companies that Arch Linux is highly stable and has little problem, but may be for advanced users) Debian apparently has this one problem that got Valve to switch, which is a development freeze period in between major releases that causes major chaos. I feel Debian is stable, but the modifications that Ubuntu makes is problematic, but highly compatible since it is the top Linux distribution.

I have also done some research on (Lenovo) Thinkpads, and I have found that the Thinkpad is unfortunately not an option (Lenovo only has 2 Linux-based Thinkpads, 3 Linux devices in total, and all of them contain an NVIDIA GPU, which is something I want to continue NEVER having in ANY of my computers, in the words of Linus Torvalds "NVIDIA, fuck you") it also only has 256 gigabytes of storage, I require a minimum of 1000 gigabytes. Everything else about them was fine. I really wanted to try a Thinkpad, but I can't due to these limitations. I will continue looking for a durable laptop with my specifications.

Today, I worked on unlocking the final steps of GitHub styled Git (OctoGit) I began to experiment with Actions, workflows, and Rubygems today, alonh with all the usual work. I also learned of the *.mdown file extension, the 4th Markdown file extension I know of now. I got all my work done today, except for a status post.
...
No problems today other than the `o` key and the pre-boot system check. - 2021 October 5th to October 6t
...
Date of start: 2021 Monday June 21st (day 1) to: 2021 Monday, October 8th (day 109)
...
I did not catch up on MB/DDG image work today. I failed to do it today due to recovery from a massive bowel problem. I really hope to do so continue working on this project tomorrow. - October 8th 2021

**This section was last updated on 2021, Saturday, October 9th at 12:43 am**
...
**Line count (including blank lines and compiler line):** `3,353`
