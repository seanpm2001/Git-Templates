...
### Status update: 2021 October 11th
...
🎂 **Days until 2 year GitHub :octocat: anniversary:** `235` _(as of 2021 October 11th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #1 !-->

:octocat: **GitHub consecutive day count:** `494/539` _Count revised and updated on July 16th 2021 via_ [DuckDuckGo](https://duckduckgo.com/?t=ffab&q=Days+since+May+25th+2020&ia=answer) _(As of 2021 October 11th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #2 !-->

🐧 **Linux desktop consecutive day count:** `453/494` _(as of 2021 October 11th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #3 !-->
...
🐧 **Ubuntu 20.04 with GitHub consecutive day count:** `453/494`  _(as of 2021 October 10th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #5 !-->

:atom: **Total amount of original GitHub repositories:** `1,251+o` _(as of 2021 October 11th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #6 !-->

:atom: o=organizations, total number of non-fork organization repositories: `107` _as of 2021 October 11th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #7 !-->
...
:electron: **Repositories created so far this month:** `121+o` _(as of 2021 October 11th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #8 !-->

:shipit: **Organization count:** `667` _(as of 2021 October 11th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #9 !-->

:electron: **Organizations created so far this month:** `6` _(as of 2021 October 11th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #10 !-->
...
I had a difficult day with development today. I dealt with a lot of stomach pain again, and I was distracted a lot. Today, I decided to fork every GitHub Pages and every Snapcraft project I have to my main account (since they are stored in an organization(s)) this process took about an hour, and resulted in my repository count jumping by 101, and added a lot of confusion today, as when I went to check my 354 commits, it turned out there were actually 253 commits. It also made it so I can't see 76 of the repositories I forked today, unless done through notes.

Today, I did marine biology and DuckDuckGo work early, both projects receiving important updates. The Marine Biology project received a brief overhaul to the activity files, with support for a feeding log, better dropdowns, and new info, while my DuckDuckGo image repository received its first weight conversion translations.

I did some research on languages last night, and I have decided to start using JavaScript++ (JS++) as a preferred superset of JavaScript, and also to start using AssemblyScript as a preferred superset of WebAssembly. I also additionally plan to learn AMPL. I also learned today that LLVM isn't just a collection of compilers, but it also is its own language. I will try to learn that as well.

Today, I reached the near halfway point with my GitHub Organization Info (GOI) status file work. It is still eating up a lot of time. I also was in the process of setting up PayPal today, so that I could set up Patreon and make all my sponsor buttons be a lot less disappointing, and actually work. Despite all the problems with PayPal, I am stuck with them for now, as my family couldn't agree upon Stripe. The reason being, my family is a lot more familiar with PayPal and doesn't want to risk going for another service. I will switch from PayPal in the future, but I might have to switch when problems occur. This project got delayed today.

Tonight, my computer crashed twice, as I was loading a document I haven't loaded in over a month, and a possibly  unrelated graphical bug happened, which poisoned my Linux/XORG session, introducing a dangerous bug that crashed my system twice. The first crash was recoverable, and I wasn't kicked out of the login page, I even got to keep my system monitor specifications and about 5 MiB of SWAP for some reason. I recovered all my work, and rewrote 3 documents from memory with high accuracy, then tried to get some more work done. I eventually went back to the document and tried going to the very top, as the top quarter of the first page wasn't loading. I tried selecting it, it formed a `+` pattern in the selection, and the system froze up and crashed. This time, I couldn't get past the login screen, I kept getting kicked out every time I tried to log in. I had to shut down and start back up. I am hoping the document isn't damaged. It is still highly readable and functional, but it seems poisonous now for some reason.

I have also noted today that out of my various GitHub pages projects, the Reactop project is the most popular, with 5 unique stars (6 when including mine) you could make a fractal out of this. I may revive the project sooner than expected now, as there seems to be a lot of interest.

I decided to go to bed early tonight and skip my journaling for tonight (I never entirely skip it, as I still wrote over 50 lines of notes to work with tomorrow, it just means I have to work on it for an extra hour tomorrow) I just can't keep with a schedule where I stay up until 3:00 am. It is not good, and I had to fix it.
...
I was unable to get to a daily hard drive backup today. - 2021 September 21st to 2021 October 11th
...
**This section was last updated on 2021, Tuesday, October 12th at 12:19 am**
...
No problems with the keyboard today :) - 2021 October 12th
...
I did not work on/create any new IDE projects again today - 2021 September 18th to 2021 October 12th
...
Date of start: 2021 Monday June 21st (day 1) to: 2021 Saturday, October 10th (day 111)
...
I had some quality family time socialization today. - October 5th to October 12th
...
I succeeded in catching up tonight, and I stayed caught up today. - 2021 October 9th to October 11th
...
**Line count (including blank lines and compiler line):** `3,352`
