...
### Status update: 2021 October 6th
...
🎂 **Days until 2 year GitHub :octocat: anniversary:** `238` _(as of 2021 October 6th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #1 !-->

:octocat: **GitHub consecutive day count:** `493/538` _Count revised and updated on July 16th 2021 via_ [DuckDuckGo](https://duckduckgo.com/?t=ffab&q=Days+since+May+25th+2020&ia=answer) _(As of 2021 October 6th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #2 !-->

🐧 **Linux desktop consecutive day count:** `452/493` _(as of 2021 October 6th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #3 !-->

🪟 **Windows 10 with GitHub consecutive day count:** `45` <!-- (Yes I am aware that the count messed up in the past 2 weeks. I haven't gotten to fixing it yet) !--> _(as of 2021 October 5th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #4 !-->

🐧 **Ubuntu 20.04 with GitHub consecutive day count:** `452/493`  _(as of 2021 October 6th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #5 !-->
...
:electron: **Repositories created so far this month:** `6+o` _(as of 2021 October 6th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #8 !-->

:shipit: **Organization count:** `667` _(as of 2021 October 6th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #9 !-->

:electron: **Organizations created so far this month:** `2` _(as of 2021 October 6th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #10 !-->
...
I had a decent day with development today. I was still recovering from yesterday. I spent time working on the status post entry for Python, turning it into its own separate repository, which aims to showcase my knowledge and learn more about various programming languages. Python is just the start. C, HTML, Markdown, Perl, Java, Prolog, CSS, JavaScript, C++, Assembly, FORTRAN, Vala, Boo, Genie, Ruby, Pascal and others are next.

I also began working on an idea I got last night that stuck with me. The WebP image format absolutely shouldn't exist in its current state, considering I don't have a single software piece for viewing the files (yes, Firefox can display and download WebP images that are on a webpage, but I can't view them separately from the HTML body. That is one of the reasons why I decided to start the WebNetPlus project, including the full suite, known as NetM (Network Media) and its 2 sister projects (NetV (Network Video) & NetP (Network Photograph)) LOOK AT THIS PHOTOGRAPH - :nickel::back:

The goal of these formats is to emulate the WebM and WebP file formats, while retaining a more Libre approach. Additionally, the goal is to also export these formats to other formats, serve as a media player for these formats, and also have a browser extension that can separately do all of this.

I did some organization work today, and worked on catching up on missed work from yesterday.

Miscellaneaous note: Khan Academy removed the video section from the mobile version of the site.

I got work done on all default projects today, except for my status post, which I fell behind on. Today was a good day for development.
...
**This section was last updated on 2021, Wednesday, October 6th at 12:10 am**
...
No problems today other than the `o` key and the pre-boot system check. - 2021 October 5th to 2021 October 6th
...
**Line count (including blank lines and compiler line):** `3,325`
