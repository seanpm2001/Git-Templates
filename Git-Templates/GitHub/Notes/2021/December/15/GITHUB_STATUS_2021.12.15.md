...
!-->
🎂 **Days until 2 year GitHub :octocat: anniversary:** `230` _(as of 2021 December 15th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #1 !-->

:octocat: **GitHub consecutive day count:** `558/621` _Count revised and updated on July 16th 2021 via_ [DuckDuckGo](https://duckduckgo.com/?t=ffab&q=Days+since+May+25th+2020&ia=answer) _(As of 2021 December 15th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #2 !-->

🐧 **Linux desktop consecutive day count:** `517/558` _(as of 2021 December 15th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #3 !-->

🪟 **Windows 10 with GitHub consecutive day count:** `45` <!-- (Yes I am aware that the count messed up in the past 2 months. I haven't gotten to fixing it yet) !--> _(as of 2021 December 14th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #4 !-->

🐧 **Ubuntu 20.04 with GitHub consecutive day count:** `517/584`  _(as of 2021 December 15th at 00:12:00 am to 11:59:59)_  <!-- COUNTER #5 !-->

:atom: **Total amount of original GitHub repositories:** `1,530+o` _(as of 2021 December 15th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #6 !-->
...
:atom: o=organizations, total number of non-fork organization repositories: `115` _as of 2021 December 15th 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #7 !-->
...
:electron: **Repositories created so far this month:** `101+o` _(as of 2021 December 15th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #8 !-->

:shipit: **Organization count:** `760` _(as of 2021 December 15th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #9 !-->

:electron: **Organizations created so far this month:** `40` _(as of 2021 December 15th at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #10 !-->
...
Yesterday, I got further caught up, and started to add mass automation (CI, Continuous Integration) to projects, despite it currently failing with no easy way of me fixing it yet. I also did mass work on Repo Data, and got caught up on status file, activity file, and Git-image part B work, with only Marine Biology work remaining.

Today, I had another good day with development. I now have a new set of standards to how projects are written. For example, 2 workflows are mandatory in every project: `super-lint` and `makefile`. `CodeQL-analysis` is an optional must-have as well, but isn't available in all projects.
...
Today, I worked on continuing to catch up and write notes. I have gotten halfway done with status files, but I won't publish until ready (likely tomorrow) I did lots of research today, and did some IDE work. I again did not work on ZooTree.

As part of research from last night, I am now announcing that I am supporting the StopKillerRobots foundation (a group that opposes robots being used in war to kill people. This includes but is not limited to drones (especially when they are used for drone strikes) attack robots, tanks, etc.)) this has been stated many times by many people: robots should NOT be used for violence/combat. Using them to do so violates the first law of robotics, and is highly inhumane, as a robot cannot feel empathy (many top AI researchers have also noted that AI cannot feel empathy or creativity) I am opposed to war in general, but I have to start publicly supporting the efforts against this type of warfare.

I also researched the concept of removing the backend, and only having the front-end. During this research, I also found that another one of my ideas has already been done (testing software to make sure it works offline, and standardizing this) I will work on supporting the existing project, but will still produce my own variant eventually. While I am on this subject, I would like to note that I am against SPAs (Single Page Applications) I have never liked them, I have found them to be problematic. I learned a new acronym for them today (SPA)

I worked on re-blogging every Quora post I have seen from 3 different communities today, as Quora has been a Græy spot in my documentation for a couple years.

I managed to stay further caught up today. I am still behind on Marine Biology work. I recently accidentally searched myself up, and found that the amount of results has increased significantly since I publicly proclaimed that I was fine with mirrors of my work. It is really nice, I just hope that eventually more people come to talk to me about my work directly. A notable shoutout goes to `awesomeopensource`
...
Compliance data error: cannot resolve date. Action aborted. - 2021 October 20th to 2021 December 13th
...
I did not work on any IDE projects today. - 2021, Tuesday, December 14th to 2021, Wednesday, December 15th
...
**Line count (including blank lines and compiler line):** `3,758`
