...
<h1 align="center">
  <img src="https://avatars1.githubusercontent.com/u/29598503?v=3&s=256" alt="Bosky">
  <br />
  Bosky
</h1>

<p align="center"><b>This is the snap for the Bosky</b>, <i>“Single-line elevator pitch for your amazing snap”</i>. It works on Ubuntu, Fedora, Debian, and other major Linux distributions.</p>
...
upstream so the Bosky project can authoritatively publish future releases for the snapcraft platform.
  ...
  - [ ] Update logos and references to `Bosky` and `[my-snap-name]`
