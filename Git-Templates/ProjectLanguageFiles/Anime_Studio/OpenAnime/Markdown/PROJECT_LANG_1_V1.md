...
## For Anime_Studio/OpenAnime

I chose Markdown as the first project language file for this project (Anime_Studio/OpenAnime) as this project is mostly just a documented portal page, although some WebVTT data is available, which will be included in a separate project language file. Markdown is getting its own project language file, starting here.
...
**File version:** `1 (2023, Wednesday, February 22nd at 12:12 pm PST)`
