...
## For seanpm2001/DeciCube

I chose Markdown as the first project language file for this project (seanpm2001/DeciCube) as this project is just documentation and an article set on the proposed DeciCube decillion byte maximum density storage system. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Monday, August 22nd at 3:21 pm PST)`
