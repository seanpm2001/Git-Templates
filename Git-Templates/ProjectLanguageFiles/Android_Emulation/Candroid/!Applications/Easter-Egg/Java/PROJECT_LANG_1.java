...
// For: Candroid-Easter-Egg
// About:
// I decided to make Java the 1st project language file for this project (Candroid-Easter-Egg) as the native application langugae for the framework this program runs on is Java. Java is the best-suited language here for this reason. It is getting its own project language file, starting here.
public class projectLanguageFileOne() {
	public static void main(String args) {
		System.out.println("Project language file 1");
		System.out.println("For: Candroid-Easter-Egg");
...
/* File info
* File version: 1 (2022, Wednesday, November 30th at 4:33 pm PST)
