...
@.2str = internal constant [27 x i8] c"For: seanpm2001/Learn-LLVM\00"
@.3str = internal constant [6 x i8] c"About:\00"
@.4str = internal constant [347 x i8] c"I decided to make LLVM the main project language file for this project (Seanpm2001/Learn-LLVM) as LLVM is the language this project is dedicated to, because this project is about learning the LLVM programming language. It only makes sense to LLVM the official language for this project. It is getting its own project language file, starting here.\00"
...
; File version: 1 (2022, Friday, September 2nd at 6:09 pm PST)
