...
## For seanpm2001/Copyright

I chose Markdown as the first project language file for this project (seanpm2001/Copyright) as this project is just documentation and an article set on the problems with copyright, and as a redirection to my Copyleft repository, all of which is written in Mardown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Wednesday, December 7th at 6:00 pm PST)`
