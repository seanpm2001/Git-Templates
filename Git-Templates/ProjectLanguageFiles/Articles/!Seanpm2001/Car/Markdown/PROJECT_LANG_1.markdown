...
## For seanpm2001/Seanpm2001-Car

I chose Markdown as the first project language file for this project (seanpm2001/Seanpm2001-Car) as this project is just documentation and an article set on the search for an all-electric car that fits my software needs, of which the articles are written in Mardown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Thursday, July 14th at 3:21 pm PST)`
