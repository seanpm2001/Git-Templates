...
## For seanpm2001/Seanpm2001-Hardware

I chose Markdown as the first project language file for this project (seanpm2001/Seanpm2001-Hardware) as this project is just documentation and an article set on my lines of hardware, and what they are for. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Monday, August 22nd at 2:07 pm PST)`
