...
## For seanpm2001/Commit-Count-Milestones

I chose Markdown as the first project language file for this project (seanpm2001/Commit-Count-Milestones) as this project is just documentation and an article set on my projects and their commit ranking/count history. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Wednesday, August 17th at 6:47 pm PST)`
