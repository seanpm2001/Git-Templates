...
I chose Markdown as the first project language file for this project (seanpm2001/Docs) as this project is just a documentation set that is written in Markdown. Markdown is the most fitting language for a project language file here. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Thursday, November 17th at 9:10 pm PST)`
