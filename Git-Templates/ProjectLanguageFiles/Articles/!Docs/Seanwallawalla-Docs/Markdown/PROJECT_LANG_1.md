...
## For seanpm2001/Seanwallawalla-Docs

I chose Markdown as the first project language file for this project (seanpm2001/Seanwallawalla-Docs) as this project is just a documentation set that is written in Markdown. Markdown is the most fitting language for a project language file here. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Friday, November 18th at 8:05 pm PST)`
