...
## For seanpm2001/Ransomware-Info

I chose Markdown as the first project language file for this project (seanpm2001/Ransomware-Info) as this project is just documentation and an article set on Ransomware, how to counteract it, how to deal with it, and how to manage it. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Monday, August 22nd at 2:16 pm PST)`
