...
## For seanpm2001/MasterMasterMaster

I chose Markdown as the first project language file for this project (seanpm2001/MasterMasterMaster) as this project is just documentation and an article set on my views in support of the word master and opposition to it being associated only with slavery. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Wednesday, August 17th at 6:10 pm PST)`
