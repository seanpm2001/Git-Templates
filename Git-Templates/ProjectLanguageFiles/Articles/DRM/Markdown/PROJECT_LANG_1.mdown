...
I chose Markdown as the first project language file for this project (seanpm2001/DRM) as this project is just documentation and an article set on the concept of DRM, and its many permanent problems. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Wednesday, August 17th at 5:55 pm PST)`
