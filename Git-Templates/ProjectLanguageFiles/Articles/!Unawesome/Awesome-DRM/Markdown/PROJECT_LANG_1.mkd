...
## For seanpm2001/Awesome-DRM

# DISCLAIMER: DRM is NOT AWESOME, this article is an anti-DRM article

I chose Markdown as the first project language file for this project (seanpm2001/Awesome-DRM) as this project is just documentation and an article set on a listing of DRM, and all the problems with it. DRM is not awesome. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Wednesday, August 17th at 6:22 pm PST)`
