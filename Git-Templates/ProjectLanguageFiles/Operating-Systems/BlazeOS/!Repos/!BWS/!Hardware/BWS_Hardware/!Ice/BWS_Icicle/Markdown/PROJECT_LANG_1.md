...
## For seanpm2001/BWS_Icicle

I chose Markdown as the first project language file for this project (seanpm2001/BWS_Icicle) as this project is just documentation and an article set on the outline of BWS Icicle hardware design, and as a portal page for the Icicle hardware from the Ice hardware wing of the hardware wing of BlazeOS/BWS. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Friday, August 19th at 6:05 pm PST)`
