...
## For seanpm2001/BWS_Hardware_Ice

I chose Markdown as the first project language file for this project (seanpm2001/BWS_Hardware_Ice) as this project is just documentation and an article set on the outline of BWS Ice hardware design, and as a portal page for the Ice wing of the hardware wing of BlazeOS/BWS. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Friday, August 19th at 5:55 pm PST)`
