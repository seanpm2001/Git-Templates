...
interface {
  ...
  * For: BathHouseOS : SankOS
  * About:
  * I decided to make nesC the 1st project language file for this project (BathHouseOS: SankOS) as the core system (TinyOS) is written mostly
...
* File version: 1 (2022, Tuesday, May 10th at 7:00 pm PST)
