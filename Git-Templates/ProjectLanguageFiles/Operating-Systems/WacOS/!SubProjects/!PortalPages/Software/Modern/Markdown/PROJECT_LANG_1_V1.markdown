...
## For WacOS/%%PortalPages%%/Modern WacOS/Software

I chose Markdown as the first project language file for this project (WacOS/Modern WacOS/Software) as this project is just an article set that indexes all the provided software for the modern WacOS subsystem, and the article is written in Markdown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Thursday, June 9th at 2:03 pm PST)`
