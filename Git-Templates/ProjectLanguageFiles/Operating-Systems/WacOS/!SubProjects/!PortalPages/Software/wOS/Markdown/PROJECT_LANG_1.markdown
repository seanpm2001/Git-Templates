...
## For WacOS/%%PortalPages%%/wOS/Software

I chose Markdown as the first project language file for this project (WacOS/wOS/Software) as this project is just an article set that indexes all the provided software for the wOS subsystem, and the article is written in Markdown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Friday, June 10th at 11:19 pm PST)`
