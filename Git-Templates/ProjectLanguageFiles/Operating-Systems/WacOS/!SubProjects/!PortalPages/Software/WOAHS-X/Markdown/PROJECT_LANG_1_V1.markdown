...
## For WacOS/%%PortalPages%%/WOAHS-X/Software

I chose Markdown as the first project language file for this project (WacOS/WOAHS-X/Software) as this project is just an article set that indexes all the provided software for the WacOS WOAHS-X subsystem, and the article is written in Markdown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Wednesday, June 8th at 7:34 pm PST)`
