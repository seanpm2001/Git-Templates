...
## For WacOS/%%PortalPages%%/Wac_OS_X/Software

I chose Markdown as the first project language file for this project (WacOS/Wac OS X/Software) as this project is just an article set that indexes all the provided software for the WacOS (Wac OS X) subsystem, and the article is written in Markdown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Thursday, June 9th at 1:53 pm PST)`
