...
## For WacOS/%%PortalPages%%/whyWatchOS/Software

I chose Markdown as the first project language file for this project (WacOS/whyWatchOS/Software) as this project is just an article set that indexes all the provided software for the whyWatchOS subsystem, and the article is written in Markdown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Monday, June 13th at 7:46 pm PST)`
