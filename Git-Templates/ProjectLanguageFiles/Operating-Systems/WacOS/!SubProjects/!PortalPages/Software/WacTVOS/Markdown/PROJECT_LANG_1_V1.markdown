...
## For WacOS/%%PortalPages%%/WacTVOS/Software

I chose Markdown as the first project language file for this project (WacOS/WacTVOS/Software) as this project is just an article set that indexes all the provided software for the WacTVOS subsystem, and the article is written in Markdown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Monday, June 13th at 7:53 pm PST)`
