...
var str = "Project language file 1\nFor: wOS/Software/Calculator\nAbout:\nI have chosen Swift as the first project language file for this project (WacOS/wOS/Software/Calculator) as Swift is a common Apple language to use, and is needed for modern parts of this project, along with cross-compatibility, and software diversity reasons. It is getting its own project language file, starting here.";
myValue = @String
let myValue = str();
return myValue;
break;
...
// File version: 1 (2022, Friday, June 10th at 11:14 pm PST)
