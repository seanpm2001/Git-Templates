...
## For seanpm2001/DSuite

I chose Markdown as the first project language file for this project (seanpm2001/DSuite) as this project is just documentation and an article set on the DSuite software set, and as a redirection to my DSuite repositories. The documentation here is written in Markdown. It is getting its own project language file, starting here.
...
**File version:** `1 (2023, Sunday, January 15th at 5:00 pm PST)`
