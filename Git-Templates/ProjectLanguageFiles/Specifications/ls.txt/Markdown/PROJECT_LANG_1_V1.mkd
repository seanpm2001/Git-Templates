...
## For seanpm2001/ls.txt

I chose Markdown as the first project language file for this project (seanpm2001/ls.xt) as this project is just documentation and an article set on the ls.txt specification. I would have chosen plain text as the official language for this project, but the GitHub linguist doesn't recognize it as a language. I will make it an offical language in a secondary project language file. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Sunday, September 4th at 7:36 pm PST)`
