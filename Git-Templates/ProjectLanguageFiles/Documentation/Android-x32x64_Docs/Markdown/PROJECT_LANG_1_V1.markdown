...
## For seanpm2001/Android-x32x64_Docs

I chose Markdown as the first project language file for this project (seanpm2001/Android-x32x64_Docs) as this project is just documentation and an article set on the Android x32x64 operating system LiveCD project, the documentation is written in Mardown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Tuesday, December 20th at 11:05 pm PST)`
