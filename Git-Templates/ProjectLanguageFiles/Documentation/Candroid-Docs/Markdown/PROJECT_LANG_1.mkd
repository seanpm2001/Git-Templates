...
## For seanpm2001/Candroid-Docs

I chose Markdown as the first project language file for this project (seanpm2001/Candroid-Docs) as this project is just documentation and an article set on the Candroid framework, the documentation is written in Mardown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Thursday, December 8th at 5:08 pm PST)`
