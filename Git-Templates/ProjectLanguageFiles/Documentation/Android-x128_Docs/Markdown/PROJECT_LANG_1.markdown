...
## For seanpm2001/Android-x128_Docs

I chose Markdown as the first project language file for this project (seanpm2001/Android-x128_Docs) as this project is just documentation and an article set on the Android x128 operating system project, the documentation is written in Mardown. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Monday, December 12th at 8:04 pm PST)`
