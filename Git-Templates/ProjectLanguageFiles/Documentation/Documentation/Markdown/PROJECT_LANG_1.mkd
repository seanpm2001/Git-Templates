...
## For seanpm2001/Documentation

I chose Markdown as the first project language file for this project (seanpm2001/Documentation) as this project is my main documentation set, the documentation is written in Markdown. It is getting its own project language file, starting here.
...
**File version:** `1 (2023, Thursday, January 26th at 7:37 pm PST)`
