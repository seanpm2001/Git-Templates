...
## For seanpm2001:DeGoogle-your-Life/Current-Catalogue

I chose Markdown as the first project language file for this project (seanpm2001:DeGoogle-your-Life/Current-Catalogue) as this project is just a listing of DeGoogle articles on current Google products from Seans DeGoogle article series. The documentation is written in Markdown, so the project language will match that. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Saturday, December 31st at 9:35 pm PST)`
