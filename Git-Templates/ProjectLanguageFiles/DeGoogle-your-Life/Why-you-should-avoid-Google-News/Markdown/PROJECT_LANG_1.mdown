...
## For seanpm2001:DeGoogle-your-Life/Why-you-should-avoid-Google-News

I chose Markdown as the first project language file for this project (seanpm2001:DeGoogle-your-Life/Why-you-should-avoid-Google-News) as this project is just documentation and an article set on DeGoogling from the usage of the Google Search engine and its associated "Google News" news aggregation service. It is getting its own project language file, starting here.
...
**File version:** `1 (2022, Friday, December 23rd at 8:52 pm PST)`
